...
export const NeonGradientCard: React.FC<NeonGradientCardProps> = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "relative size-full min-h-[inherit] rounded-(--card-content-radius) bg-gray-100 hover:bg-gray-100/90 hover:dark:bg-neutral-900/95 p-6 select-none",
          ...
          "after:bg-[linear-gradient(0deg,var(--neon-first-color),var(--neon-second-color))] after:bg-size-[100%_200%] after:opacity-50 dark:after:opacity-20",
